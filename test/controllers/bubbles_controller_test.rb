...
class BubblesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bubble" do
    assert_difference("Bubble.count") do
      post bubbles_url, params: { bubble: { category_id: @bubble.category_id, description: @bubble.description, name: @bubble.name, priority: @bubble.priority } }
    end
  ...
  test "should update bubble" do
    patch bubble_url(@bubble), params: { bubble: { category_id: @bubble.category_id, description: @bubble.description, name: @bubble.name, priority: @bubble.priority } }
